 ...
 ?>
  <html>
    <head>
      ...
      <title>Gérer les Requêtes</title>
    ...
    <body>
      ...
      <nav>
        <div class="nav-wrapper blue">
          ...
          <h4 class="brand-logo gerer">Gérer les requêtes</h4>
     ...
     <div class="row">
           ...
           <?php
            $req = $bdd->query('SELECT * FROM requete');
        ...
        <div class="col s12 m7">
            ...
            <div class="card-stacked">
              <div class="card-content">
                ...
                <div class="col s12">
                  ...
                  <h5 class="blue-text">Élève :</h5>
                </div>
                <div class="col s3">
                </br>
                  <p style="float:left"><b>ID Élève :</b> <?php echo '<p class="blue-text"> &nbsp' .$requete['id_emetteur']. '</p>' ?></p>
                </div>
                <div class="col s3">
                  </br>
                  <p style="float:left"><b>Nom :</b> <?php echo '<p class="blue-text"> &nbsp' .$requete['nom_emetteur']. '</p>' ?></p>
                </div>
                <div class="col s3">
                  </br>
                  <p style="float:left"><b>Prénom :</b> <?php echo '<p class="blue-text"> &nbsp' .$requete['prenom_emetteur']. '</p>' ?></p>
                </div>
                <div class="col s3">
                  </br>
                  <p style="float:left"><b>Classe :</b> <?php echo '<p class="blue-text"> &nbsp' .$requete['classe_emetteur']. '</p>' ?></p>
                </div>
                <div class="col s12">
                </br>
              ...
              <div class="card-action">
                ...
                <div class="col s3">
                  <button type="submit" name="accepter" href="" class="btn waves-effect waves-light green">Accepter</button>
                </div>
              <div class="col s3">
                <button type="submit" href="" name="rejeter" class="btn waves-effect waves-light red">Rejeter</button>
              </div>
                </form>
            </div>
          </div>
          <?php
            if (isset($_POST['accepter'])) {
              $statut = "valide";
              $insertstatut = $bdd->prepare("UPDATE requete SET statut_requete = ? WHERE id_requete = ?");
              $insertstatut->execute(array($statut, $requete['id_requete']));
            }
